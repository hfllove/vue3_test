  ...
  methods: {
    ...
    async addShopCart () {
      try {
        ...
        // 产品信息比较复杂，需要使用会话存储（不持久化，会话结束数据消失）
        sessionStorage.setItem("SKUINFO",JSON.stringify({skuInfo:this.skuInfo,spuSalelist:this.spuSaleAttrList}))
        // 路由跳转
